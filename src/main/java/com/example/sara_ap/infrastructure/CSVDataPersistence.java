...
// 🔑 CORREGIDO: Ahora apuntan a la estructura de tu nuevo proyecto (sara_ap)
...
public class CSVDataPersistence {
    ...
    // 📂 RUTAS CORREGIDAS: Apuntan directo a la carpeta resources de Maven
    private static final String RESOURCES_PATH = "src/main/resources/";
    private static final String STUDENTS_FILE = RESOURCES_PATH + "students.csv";
    private static final String PROFESSORS_FILE = RESOURCES_PATH + "professors.csv";
    private static final String COURSES_FILE = RESOURCES_PATH + "courses.csv";
    private static final String GRADES_FILE = RESOURCES_PATH + "grades.csv";
